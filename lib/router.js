...
var renderPage = function(skelly, req, res, thisPath) {
  ...
  var thisController = path.join(skelly.appRoot,'controllers',thisPath);
...
var renderJSFile = function(skelly, req, res, thisPath) {
  ...
  // if isDevel and looking for the source file
    ...
    renderStaticFile(skelly, req, res, skelly.appRoot, thisPath, false);
...
var renderImageFile = function(skelly, req, res, thisPath) {
  ...
  var dir = path.join(skelly.appRoot,'images');
...
var render404 = function(skelly, req, res) {
  require(path.join(skelly.appRoot,'controllers','404'))(skelly, req, res);
};
...
var checkStatic = function(skelly, req, res, thisPath, callback) {
  var stat = fs.existsSync(path.join(skelly.appRoot,'htroot',thisPath));
  ...
  logger(req, res, function (err) {
    ...
    // handle images files
      ...
      checkStatic(skelly, req, res, thisPath, function(isStatic) {
        ...
        if (isStatic) {
          renderStaticFile(skelly, req, res, path.join(skelly.appRoot,'htroot'), thisPath, false);
